...
public class SchoolContentProvider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://inqb8.ansteph.oasis.contentprovider.schoolcontentprovider/oasis");
    private SQLiteDatabase db;

    public DbHelper databhelper ;

    public SchoolContentProvider() {
    }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        int retVal = db.delete(Tables.SCHOOL, selection,selectionArgs);
    ...
    public Uri insert(Uri uri, ContentValues inValues) {
        ...
        long rowId = db.insert(Tables.SCHOOL, SchoolColumns.NAME, values);
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        {
            orderBy = SchoolColumns.NAME;
        }else {
            orderBy =sortOrder;
        }

        Cursor c = db.query(Tables.SCHOOL, projection,selection,selectionArgs,null,null,orderBy);
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        int retVal = db.update(Tables.SCHOOL, values, selection,selectionArgs);
        getContext().getContentResolver().notifyChange(uri, null);
