...
public class CityContentProvider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://inqb8.ansteph.oasis.contentprovider.citycontentprovider/oasis");
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        int retVal = db.delete(Tables.CITY, selection,selectionArgs);
    ...
    public Uri insert(Uri uri, ContentValues inValues) {
        ...
        long rowId = db.insert(Tables.CITY, CityColumns.NAME, values);
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        {
            orderBy = CityColumns.NAME;
        }else {
            orderBy =sortOrder;
        }

        Cursor c = db.query(Tables.CITY, projection,selection,selectionArgs,null,null,orderBy);
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        int retVal = db.update(Tables.CITY, values, selection,selectionArgs);
        getContext().getContentResolver().notifyChange(uri, null);
