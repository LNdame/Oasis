...
public class TextViewLevelTwo extends LinearLayout {

    TextView txtInfo ;

    public TextViewLevelTwo(Context context) {
        super(context);
        initViews(context);
    }

    public TextViewLevelTwo(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initViews(context, attrs);
    }

    public TextViewLevelTwo(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initViews(Context context) {
        LayoutInflater.from(context).inflate(R.layout.textview_level2, this);
